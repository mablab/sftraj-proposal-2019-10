...
package at the end of the first stage of the work. Despite strong
delay to actually start the work due to administrative difficulties,
we do not foresee further delay in delivering the foundations of the
...
* **Companion manuscript for the R Journal:** Mathieu Basille has
  ...
  right after the package reached a stable state and was published on
  CRAN.
