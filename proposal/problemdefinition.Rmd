...
In a nutshell, this work in isolation is mostly due to a lack
of a modern infrastructure to deal with trajectories in R.  We
recently started working on the `sftraj` package, a project supported
...
2. Contribute to the foundations of a true community in the ecosystem of packages 
that relies on `sftraj` for handling tracking data

[//]: # (RJ: I modified point number 2 as I think that it is what you mean. 
If this is too much, then how about "Optimize potential usability of straj to 
build the foundations of an ecosystem of movement packages that would work truly
as a community"?)
